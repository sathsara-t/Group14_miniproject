...
const els = {
    ...
    navAddExpense: document.getElementById('navAddExpense'),
...
function init() {
    ...
    els.navAddExpense.addEventListener('click', (e) => {
        e.preventDefault();
        if (allowance > 0) {
            showSection('addExpense');
        } else {
            showSection('allowance');
        }
    });
...
function showSection(sectionName) {
    ...
    els.addExpenseSection.classList.add('hidden');
    ...
    els.navAddExpense.classList.remove('active');
    ...
    } else if (sectionName === 'addExpense') {
        els.addExpenseSection.classList.remove('hidden');
        els.navAddExpense.classList.add('active');
